...
public class Exposure implements Serializable{
	 ...
	 * 
	 */
	public static String DIRECT_EXPOSURE="D";
	public static String INDIRECT_EXPOSURE="I";
	private static final long serialVersionUID = 1185662625944767391L;
	...
	public static void main(String[] args) {
		System.out.println(LocalDateTime.of(2022,10,31,12,30).compareTo(LocalDateTime.now()));
	}
}
